...
.tab {
  ...
  &__label {
    ...
    border-radius: 10px;
    padding: 12px;
    transition: margin-right 0.2s ease, border 0.4s ease;
    cursor: pointer;
    svg {
      width: 20px;
      height: 20px;
